...
public class PlayIntegrity extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        getActivity().setTitle(R.string.fortune_play_integrity_dashboard_title);
        ...
        String keysList = SystemProperties.get("persist.sys.fortuneos.gms.list");
        String[] keys = keysList.split("\\+");

        for (String key : keys) {
            String value = SystemProperties.get("persist.sys.fortuneos.gms." + key);
    ...
    public void setPropertiesFromUrl() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String message = "";
                try {
                    URL url = new URL("https://gitea.com/FortuneOS/vendor_certification/raw/branch/usagi/CertifiedPropsOverlay/res/values/config.xml");
                    ...
                    for (Map.Entry<String, String> entry : properties.entrySet()) {
                        ...
                        SystemProperties.set("persist.sys.fortuneos.gms." + key, value);
                        if (keysBuilder.length() > 0) {
                            keysBuilder.append("+");
                        }
                        keysBuilder.append(key);
                    }
                    SystemProperties.set("persist.sys.fortuneos.gms.list", keysBuilder.toString());
