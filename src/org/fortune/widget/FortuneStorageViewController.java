...
import org.fortune.widget.FortuneStorageView;
import java.util.concurrent.Future;

public class FortuneStorageViewController extends BasePreferenceController {
	
	private FortuneStorageView mPreference;
	private final StorageManager mStorageManager;
	private final StorageManagerVolumeProvider mStorageManagerVolumeProvider;
	
	public FortuneStorageViewController(Context context, String key) {
		super(context, key);
